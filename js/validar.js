...
const dataNascimento = document.querySelector('[data-tipo="dataNascimento"]')
...
function enviarForm(event){
    ...
    if(validaDataNascimento(dataNascimento)==false){
   ...
   if(validaTelefone(telefone)==false){
    ...
    if(validaNome(nome)==true && validaCPF(cpf)==true && validaDataNascimento(dataNascimento)==true && validaEmail(email)==true && validaEmailConfirma(confirmaEmail)==true && validaTelefone(telefone)==true && recuperarCEP(cep)==true && validaSenha(senha)==true && validaSenhaConfirma(senha)==true && validaNumero(numeroCasa)==true && validaComplemento(complemento)==true && validaUsername(username)==true && validaCheck(checar)==true) {
        j=0
